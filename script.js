...
const storyData = [
    ...
    {
        message: "Every time I look into your eyes, I fall for you all over again. 😍",
...
const galleryStoryText = "✨ Our beginning…\n\nIt's crazy how one night can change everything.\nAugust 12, 2024 — Zinobia — a dinner night that felt soft, warm, and full of something I still can't explain.\nFrom the moment we sat down, everything felt different…\nyour smile, your voice, the way your eyes caught the light…\nit all felt like the beginning of something my heart had been waiting for.\n\nWe planned to eat tagliatelle…\nromantic, fancy, perfect for a first date.\nBut of course — because it's us — it wasn't available 😂\nSo we ended up ordering pizza, laughing like two kids who didn't care as long as we were together.\nAnd honestly, that pizza tasted better than any tagliatelle in the world…\nbecause it was with you.\n\nWe took pictures that night…\nbeautiful ones — the kind that capture more than a moment.\nThey captured a feeling, a softness, a beginning.\n\nAnd the funniest part?\nWe only decided the next day to make our relationship official — August 13.\nLike we finished the date, looked at each other and said:\n\"Okay, let's make tomorrow the date… sounds cuter.\"\nOnly us would do something like that.\n\nBut no matter the number…\nthat night — August 12 — will always be the moment everything changed for me.\nA moment I'll never forget.\nThe night the world felt warmer…\nthe night loving you started to feel like the most natural thing in my life.\n\nAnd if I had to choose again…\nI'd choose that night, that pizza, that smile,\nand you — every single time. ✨❤️";

const ringNightStoryText = "✨ The night of the promising ring…\n\nVieux Port…\nA calm night, soft lights, the sound of the water…\nbut all I remember clearly is you.\nThe way you looked that night — warm, calm, glowing —\nmade everything around us disappear.\n\nIt was my first time giving you a real gift…\nthe promising ring.\nMaybe it was small, but for me it carried all the feelings\nI didn't know how to say out loud.\n\nAnd when I opened the box and held your hand…\nI swear my heart was beating so fast.\nYour smile, the way your eyes softened —\nI'll never forget that moment.\n\nThen came the funny part…\nI was so nervous\nthat I literally put the ring on upside down 🤦‍♂️😂\nWe both stopped for a second, looked at it,\nand then started laughing like two idiots in love.\nThat laugh… that moment…\nmade the night even more perfect — perfectly us.\n\nEvery time I remember that scene,\nthe ring, your hand, your laugh…\nI feel the same warmth I felt that night.\n\nThat night at Vieux Port wasn't just a gift…\nit was a promise.\nA soft promise that I want to love you gently,\nchoose you every day,\nand make memories with you —\nthe romantic ones, the emotional ones,\nand the funny, upside-down ring ones. ✨💍❤️";

const youMeStoryText = "✨ Our love isn't perfect, but it's real… beautifully real.\n\nWe have good days and bad days, moments where we fight and moments where we can't stop laughing. But no matter what happens, we always find our way back to each other. Every single time.\n\nNo one will ever understand what we have, because our connection is something only our hearts can explain.\nWe think too much, we care too much, we love too much — and maybe that's what makes us so special.\n\nOur relationship is full of passion, full of small fights, full of big emotions, full of laughter that heals everything.\nAnd even when things get hard, we talk, we listen, we try… because we want this.\nBecause we want us.\n\nWith you, love feels honest.\nWith you, love feels strong.\nWith you, love feels worth every effort.\n\nWe're not perfect people… but together, we make something beautiful.\nAnd I'd choose this love, our love, every single day. ❤️✨";

const preciousMomentsStoryText = "✨ That night… our 1-year anniversary… it will stay in my heart forever.\n\nEverything felt special from the moment I started preparing it. I wanted the night to be perfect for you — the place, the table, the view, the gifts, the food… every little detail was for you.\n\n\"Dar El Fatha\" looked beautiful, but when you arrived, you made everything even more magical. And the full moon… it was shining exactly the way I imagined. It felt like the sky was celebrating us.\n\nI remember how happy I was, just watching you smile. I wanted you to feel loved, safe, and the center of my world. And that night… you truly were.\n\nWe danced for the first time — laughing, holding each other, feeling like time stopped.\nWe hugged, we kissed, we lived a moment that felt bigger than both of us.\n\nAnd then came the moment I'll never forget…\nI went down on one knee, holding your ring, my heart shaking inside my chest. I looked at you and asked:\n\n\"Will you be my future wife, my future life?\"\n\nYou said yes… with the most beautiful smile, and then you started crying from happiness.\nIn that moment, everything felt right. Everything felt meant to be.\n\nAnd I made you a promise — a promise I still repeat today and forever:\n\n\"I promise to stand by you. I promise to never leave you.\nMay God keep you with me forever.\nI love you so much… more than all the oxygen in this world.\"\n\nThat night wasn't just special.\nIt was the night I chose you again, with all my heart.\nThe night I knew that my life only makes sense when it's with you. ❤️✨";
...
function handleAnswer(isCorrect, wrongMessage, specialMessage = null, stepIndex = null) {
    ...
    if (isCorrect) {
        ...
        feedbackMessage.textContent = '✨ Correct! You know me so well! ✨';
...
function showSpecialMessage(message, stepIndex) {
    ...
    popup.innerHTML = `
        <div class="special-message-content">
            <button class="close-special-btn">✕</button>
            <p class="special-message-text">${message.split('\n').join('<br>')}</p>
            <button class="btn btn-primary continue-btn">Continue ❤️</button>
        </div>
    `;
